...
Spork.prefork do
  ...
  ENV["RAILS_ENV"] ||= 'test'
  require File.expand_path("../../spec/support/factory_girl/common", __FILE__)
...
Spork.each_run do
  ...
  # RTF.send(:remove_const, :Generator) if RTF.constants.include?(:Generator)
  # DOCX.send(:remove_const, :Generator) if DOCX.constants.include?(:Generator)
  # require Rails.root.join('lib', 'rtf.rb')
  # require Rails.root.join('lib', 'docx.rb')
