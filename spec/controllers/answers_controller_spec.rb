  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested answer" do
        ...
        Answer.any_instance.should_receive(:update_attributes).with({ "value" => "MyString" })
        put :update, {:id => answer.to_param, :answer => { "value" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the answer as @answer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Answer.any_instance.stub(:save).and_return(false)
        put :update, {:id => answer.to_param, :answer => { "value" => "invalid value" }}, valid_session
        assigns(:answer).should eq(answer)
      end
