  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved person as @person" do
        ...
        post :create, {:person => { "full_legal_name" => "invalid value" }}, valid_session
        assigns(:person).should be_a_new(Person)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested person" do
        ...
        Person.any_instance.should_receive(:update_attributes).with({ "full_legal_name" => "MyString" })
        put :update, {:id => person.to_param, :person => { "full_legal_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the person as @person" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Person.any_instance.stub(:save).and_return(false)
        put :update, {:id => person.to_param, :person => { "full_legal_name" => "invalid value" }}, valid_session
        assigns(:person).should eq(person)
      end
