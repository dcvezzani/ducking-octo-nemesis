  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved phone_number as @phone_number" do
        ...
        post :create, {:phone_number => { "value" => "invalid value" }}, valid_session
        assigns(:phone_number).should be_a_new(PhoneNumber)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested phone_number" do
        ...
        PhoneNumber.any_instance.should_receive(:update_attributes).with({ "value" => "MyString" })
        put :update, {:id => phone_number.to_param, :phone_number => { "value" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the phone_number as @phone_number" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PhoneNumber.any_instance.stub(:save).and_return(false)
        put :update, {:id => phone_number.to_param, :phone_number => { "value" => "invalid value" }}, valid_session
        assigns(:phone_number).should eq(phone_number)
      end
