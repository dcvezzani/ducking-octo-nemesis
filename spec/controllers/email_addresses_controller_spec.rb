  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved email_address as @email_address" do
        ...
        post :create, {:email_address => { "value" => "invalid value" }}, valid_session
        assigns(:email_address).should be_a_new(EmailAddress)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested email_address" do
        ...
        EmailAddress.any_instance.should_receive(:update_attributes).with({ "value" => "MyString" })
        put :update, {:id => email_address.to_param, :email_address => { "value" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the email_address as @email_address" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        EmailAddress.any_instance.stub(:save).and_return(false)
        put :update, {:id => email_address.to_param, :email_address => { "value" => "invalid value" }}, valid_session
        assigns(:email_address).should eq(email_address)
      end
