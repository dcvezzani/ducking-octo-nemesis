  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved child as @child" do
        ...
        post :create, {:child => { "full_legal_name" => "invalid value" }}, valid_session
        assigns(:child).should be_a_new(Child)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested child" do
        ...
        Child.any_instance.should_receive(:update_attributes).with({ "full_legal_name" => "MyString" })
        put :update, {:id => child.to_param, :child => { "full_legal_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the child as @child" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Child.any_instance.stub(:save).and_return(false)
        put :update, {:id => child.to_param, :child => { "full_legal_name" => "invalid value" }}, valid_session
        assigns(:child).should eq(child)
      end
